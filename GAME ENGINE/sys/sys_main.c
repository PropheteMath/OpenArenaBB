...
{
	int   i;
	char commandLine[] = "+set sv_pure 0 +set vm_ui 0 +set vm_game 0 +set vm_cgame 0 +set r_fullbright 1 + set r_overBrightBits 2 +set r_mapOverBrightBits 3 +set fs_basepath ./app/native";

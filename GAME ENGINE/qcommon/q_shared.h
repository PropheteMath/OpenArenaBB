...
//  #define GAMENAME_FOR_MASTER		"OpenArenaAndroid"
//#endif
  ...
  #define GAMENAME_FOR_MASTER       "QuakeArena"   // must NOT contain whitespace.  No servers show up if you use "openarena"

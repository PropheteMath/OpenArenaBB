...
void SHOWNET( msg_ttt *msg, char *s) {
...
==================
*/
void CL_DeltaEntity (msg_ttt *msg, clSnapshot_t *frame, int newnum, entityState_t *old,
					 qboolean unchanged) {
	entityState_t	*state;
...
==================
*/
void CL_ParsePacketEntities( msg_ttt *msg, clSnapshot_t *oldframe, clSnapshot_t *newframe) {
	int			newnum;
...
================
*/
void CL_ParseSnapshot( msg_ttt *msg ) {
	int			len;
	clSnapshot_t	*old;
...
==================
*/
void CL_ParseGamestate( msg_ttt *msg ) {
	int				i;
	entityState_t	*es;
	int				newnum;
...
=====================
*/
void CL_ParseDownload ( msg_ttt *msg ) {
	int		size;
...
=====================
*/
void CL_ParseCommandString( msg_ttt *msg ) {
	char	*s;
	int		seq;
	int		index;
...
=====================
*/
void CL_ParseServerMessage( msg_ttt *msg ) {
	int			cmd;

...
void CL_ServerStatusResponse( netadr_t from, msg_ttt *msg );
...
void CL_WriteDemoMessage ( msg_ttt *msg, int headerBytes ) {
	int		len, swlen;
...
===================
*/
void CL_ServersResponsePacket( const netadr_t* from, msg_ttt *msg, qboolean extended ) {
	int				i, count, total;
...
=================
*/
void CL_ConnectionlessPacket( netadr_t from, msg_ttt *msg ) {
	char	*s;
	char	*c;
...
===================
*/
void CL_ServerInfoPacket( netadr_t from, msg_ttt *msg ) {
	int		i, type;
	char	info[MAX_INFO_STRING];
	char	*infoString;
	int		prot;
...
//	masteraddress = Cvar_VariableString(command);
	masteraddress = "dpmaster.therepository.info";
...
//		cmdname = "getserversExt " GAMENAME_FOR_MASTER;
		cmdname = "getservers " GAMENAME_FOR_MASTER;

...
static void SV_VerifyPaks_f( client_t *cl ) {
	...
	if ( sv_pure->integer != 0 ) {
		...
		Com_Printf( "Expected : ui.qvm with cheksum %d ; cgame.qvm with checksum %d\n",nChkSum2, nChkSum1);
...
===============
*/
static qboolean SV_ClientCommand( client_t *cl, msg_ttt *msg ) {
	int		seq;
	const char	*s;
...
==================
*/
static void SV_UserMove( client_t *cl, msg_ttt *msg, qboolean delta ) {
	int			i, key;
	int			cmdCount;
	usercmd_t	nullcmd;

...
=============
*/
static void SV_EmitPacketEntities( clientSnapshot_t *from, clientSnapshot_t *to, msg_ttt *msg ) {
...
==================
*/
static void SV_WriteSnapshotToClient( client_t *client, msg_ttt *msg ) {

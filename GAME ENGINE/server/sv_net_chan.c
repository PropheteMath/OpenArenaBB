...
==============
*/
static void SV_Netchan_Encode( client_t *client, msg_ttt *msg ) {
...
==============
*/
static void SV_Netchan_Decode( client_t *client, msg_ttt *msg ) {
...
void SV_Netchan_Transmit( client_t *client, msg_ttt *msg) {	//int length, const byte *data ) {

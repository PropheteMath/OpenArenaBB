...
;143:	if ( ( key == K_INS ) && trap_Key_IsDown( K_SHIFT ) ) {
ADDRFP4 4
INDIRI4
CNSTI4 139
NEI4 $109
...
;180:	}
;181:
;182:	if ( key == K_HOME || ( tolower(key) == 'a' && trap_Key_IsDown( K_CTRL ) ) ) {
ADDRLP4 12
ADDRFP4 4
INDIRI4
ASGNI4
...
;186:	}
;187:
;188:	if ( key == K_END || ( tolower(key) == 'e' && trap_Key_IsDown( K_CTRL ) ) ) {
ADDRLP4 24
ADDRFP4 4
INDIRI4
ASGNI4
...
line 420
;419:
;420:				if ((m->generic.flags & QMF_UPPERCASE) && Q_islower( keycode ))
ADDRFP4 0
INDIRP4
CNSTI4 44
ADDP4
...
LABELV $200
line 422
;422:				else if ((m->generic.flags & QMF_LOWERCASE) && Q_isupper( keycode ))
ADDRFP4 0
INDIRP4
CNSTI4 44
ADDP4
...
LABELV $202
line 424
;424:				else if ((m->generic.flags & QMF_NUMBERSONLY) && Q_isalpha( keycode ))
ADDRFP4 0
INDIRP4
CNSTI4 44
ADDP4
...
line 427
;426:
;427:				MField_CharEvent( &m->field, keycode);
ADDRFP4 0
INDIRP4
CNSTI4 60
ADDP4
...
line 430
;429:			else
;430:				MField_KeyDownEvent( &m->field, keycode );
ADDRFP4 0
INDIRP4
CNSTI4 60
ADDP4

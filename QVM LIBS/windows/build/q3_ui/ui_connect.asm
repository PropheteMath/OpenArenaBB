...
LEI4 $110
line 106
;106:		s = va( "%s (%d%%)", downloadName, (int)( (float)downloadCount * 100.0f / downloadSize ) );
ADDRGP4 $112
ARGP4
ADDRFP4 0
INDIRP4
...
line 199
;198:
;199:	UI_DrawProportionalString( 320, 42, va("Connecting to %s", cstate.servername), UI_CENTER|UI_SMALLFONT|UI_DROPSHADOW, menu_text_color );
ADDRGP4 $138
ARGP4
ADDRLP4 0+12
ARGP4
